...
* Add the rspec gem and the capybara gem and run the rspec generator
* Create a static controller from the command line with the actions "about" and "contact"
* Add an h2 to each of the above actions
* Add a test that proves that those h2's are present on each
